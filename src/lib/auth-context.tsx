...
interface Profile { id: string; user_id: string; anonymous_name: string; avatar_url: string | null; bio: string | null; is_admin: boolean; is_premium: boolean; karma: number; created_at: string; updated_at?: string; premium_until?: string | null; afdian_user_id?: string | null; slug?: string | null; }
interface AuthCtx {
...
const AuthContext = createContext<AuthCtx>({
  ...
  signIn: async () => ({ error: 'not mounted' }),
  signOut: async () => {},
