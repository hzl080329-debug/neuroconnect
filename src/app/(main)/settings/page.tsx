...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      <Link href="/" className="text-[#3D7AD6] font-medium text-sm mb-6 inline-block">← 返回</Link>
      <h1 className="text-2xl font-bold text-gray-800 mb-6">设置</h1>

      {/* Language */}
      <section className="mb-8">
        <h2 className="text-lg font-semibold text-gray-800 mb-3">🌐 语言 / Language</h2>
      ...
      {/* Background Color */}
      <section className="mb-8">
        <h2 className="text-lg font-semibold text-gray-800 mb-3">🎨 背景颜色</h2>
